...
import tk.gbl.core.DBInfo;
import tk.gbl.core.FieldInfo;
import tk.gbl.template.MybatisTemplate;
import tk.gbl.template.ToBean;
...
public class MainTank {
    ...
    public void dododo() throws Exception {
        ...
        for (int i = 0; i < tables.size(); i++) {
            ...
            Map<String, FieldInfo> tableField = message.getField(tableName);
    ...
    public void genMybatisTemplateXml() throws Exception {
        ...
        for (int i = 0; i < tables.size(); i++) {
            ...
            try {
                ...
                PrintWriter pw = new PrintWriter(new File(dir, tableName
                        + ".xml"));
                pw.println(xml);
                pw.flush();
                pw.close();
